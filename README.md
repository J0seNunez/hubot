...
Cursor is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running Cursor Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start Cursor locally by running:
...
Then you can interact with Cursor by typing `Cursor help`.

    Cursor> Cursor help
    Cursor animate me <query> - The same thing as `image me`, except adds [snip]
    Cursor help - Displays all of the help commands that Cursor knows about.
    ...
